  ...
  return (
    <div className="overflow-x-auto">
      ...
      <table className="w-full text-lg text-left border mt-10 border-[var(--hoverBorder)] border-separate [@media(min-width:840px)]:border-collapse">
        ...
        <tbody>
          <tr>
            <td className="table-size__item font-semibold scroll-size__item">2XS</td>
          ...
          <tr className="bg-[var(--inputField)]">
            <td className="table-size__item font-semibold scroll-size__item">XS</td>
          ...
          <tr>
            <td className="table-size__item font-semibold scroll-size__item">S</td>
          ...
          <tr className="bg-[var(--inputField)]">
            <td className="table-size__item font-semibold scroll-size__item">M</td>
          ...
          <tr>
            <td className="table-size__item font-semibold scroll-size__item">l</td>
          ...
          <tr className="bg-[var(--inputField)]">
            <td className="table-size__item font-semibold scroll-size__item">xl</td>
          ...
          <tr>
            <td className="table-size__item font-semibold scroll-size__item">2 xl</td>
            <td className="table-size__item font-light">58-60</td>
            <td className="table-size__item font-light">95-104</td>
            <td className="table-size__item font-light">118-125</td>
          </tr>
          <tr className="bg-[var(--inputField)]">
            <td className="table-size__item font-semibold scroll-size__item">3 xl</td>
          ...
          <tr>
            <td className="table-size__item font-semibold scroll-size__item">4 xl</td>
