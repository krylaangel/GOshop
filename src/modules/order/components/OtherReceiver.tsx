...
interface OtherReceiverProps {
  ...
  errors?: Partial<Receiver>

}
export function OtherReceiver({ receiver, setReceiver, errors }: OtherReceiverProps) {
  return (
    <div className="flex gap-6 flex-col mb-8 w-full">
      ...
      <div className="gap-6 flex flex-col w-full">
        ...
        <div className="flex gap-6">
          <div className="flex flex-col">
            ...
            />
            {errors?.firstName && <p className="error__auth py-2">{errors.firstName}</p>}
          </div>
          <div className="flex flex-col">
            <input
            ...
            />
            {errors?.lastName && <p className="error__auth py-2">{errors.lastName}</p>}
          </div>
        ...
        <div className="flex gap-6">
          ...
          <div className="flex flex-col">
            ...
            />
            {errors?.phoneNumber && <p className="error__auth py-2">{errors.phoneNumber}</p>}
          </div>
